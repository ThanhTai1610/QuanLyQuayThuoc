      ...
      <div class="row">
        ...
        <div class="col-lg-3 mx-auto mb-5 mb-lg-0">
          ...
          <ul class="list-unstyled">
            <li><router-link to="/thuc-pham-bo-sung">Thực phẩm bổ sung</router-link></li>
            <li><router-link to="/vitamin">Vitamin</router-link></li>
            <li><router-link to="/dinh-duong">Ăn kiêng &amp; Dinh dưỡng</router-link></li>
            <li><router-link to="/tra-ca-phe">Trà &amp; Cà phê</router-link></li>
          </ul>
        </div>
...
<script setup>
// Code logic (nếu có) sẽ nằm ở đây
</script>